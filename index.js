...
*/
console.log('task 1b', createMenuItem('scrambled eggs', 3, 'Breakfast'));
console.log('task 1b', createMenuItem('mash potatoes & gravy', 5, 'Supper'));
console.log('task 1b', createMenuItem('ham & cheese sandwich', 4, 'Lunch'));
